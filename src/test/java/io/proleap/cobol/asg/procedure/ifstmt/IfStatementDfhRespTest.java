...
public class IfStatementDfhRespTest extends CobolTestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/asg/procedure/ifstmt/DfhRespIf.cbl");
		final Program program = new CobolParserRunnerImpl().analyzeFile(inputFile, CobolSourceFormatEnum.TANDEM);

		final CompilationUnit compilationUnit = program.getCompilationUnit("DfhRespIf");
		...
		assertNotNull(ifStatement.getThen());
		assertEquals(1, ifStatement.getThen().getStatements().size());
	}
}
